  ...
  return (
    ...
    >
      <button
        ...
        className="group px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-white hover:bg-slate-50 border border-slate-200 shadow-2xs hover:shadow-xs transition-all duration-200 flex items-center gap-1 sm:gap-2 cursor-pointer"
      ...
      >
        ...
        <Sun className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-amber-500 group-hover:rotate-45 transition-transform duration-500" />

        <span className="font-mono text-[11px] sm:text-xs font-bold text-slate-800">
          {data.temperature}°C
        </span>
