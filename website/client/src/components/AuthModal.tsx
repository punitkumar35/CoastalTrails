      ...
      <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr]">
        ...
        <div className="relative overflow-hidden p-6 sm:p-8">
          ...
          <div className="relative z-10">
            ...
            {/* Google OAuth Button - Modern Luxury Card */}
            <div className="mt-4">
              <button
                type="button"
                ...
                className={cn(
                  'group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-xl border border-line-2 bg-paper-2 px-4 py-3 text-xs sm:text-sm font-semibold text-ink shadow-xs transition-all duration-200',
                  'hover:border-line hover:bg-elevated hover:shadow-md active:scale-[0.985] disabled:cursor-not-allowed disabled:opacity-60'
                )}
              >
                ...
                {isGoogleLoading ? (
                  <motion.span
                    className="h-4 w-4 shrink-0 rounded-full border-2 border-ink-3/40 border-t-tide"
                    animate={{ rotate: 360 }}
                    transition={{ repeat: Infinity, duration: 0.75, ease: 'linear' }}
                  />
                ) : (
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center transition-transform duration-200 group-hover:scale-110">
              ...
              <div className="relative mt-4 flex items-center justify-center">
                ...
                <span className="relative bg-paper px-3 text-[10px] font-medium uppercase tracking-wider text-ink-3">
                  or with password
                </span>
                <div className="w-full border-t border-line-2" />
              </div>
