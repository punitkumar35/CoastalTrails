 ...
 * becomes visible again — used to keep user-facing pages in sync with
 * changes made from the admin dashboard (booking status, prices, details,
 * room availability) without a page reload.
 */
